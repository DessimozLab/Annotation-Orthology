...
def extract_relevant_newick_tree(fn_newick, clade):
    with open(fn_newick, 'rt') as fh:
        tree = Bio.Phylo.read(fh, 'newick')
...
if __name__ == "__main__":
    ...
    parser.add_argument('treefile', help="species tree file in newick format")
